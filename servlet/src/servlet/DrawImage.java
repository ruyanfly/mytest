...
//使用注解的好处就是允许用url调用多个servlet，因为web中的url跳转的结果都一样
public class DrawImage extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		System.out.println("this is draw post!");
	...
	//画随机字符
	//createTypeFlag是可变参数
	//Java1.5增加新特性：可变参数：使用于参数个数不确定，类型确定的情况，
	//Java把可变参数当作数组处理。注意：可变参数必须位于最后一项
	private String drawRandomNum(Graphics2D g, String...createTypeFlag) {
		//设置颜色
		g.setColor(Color.RED);
		//设置字体
		g.setFont(new Font("字体", Font.BOLD, 20));
		//常用的中国汉字
		String baseChineseChar = "\u7684\u4e00\u4e86\u662f\u6211\u4e0d\u5728\u4eba"
				+ "\u4eec\u6709\u6765\u4ed6\u8fd9\u4e0a\u7740\u4e2a\u5730\u5230\u5927"
				+ "\u91cc\u8bf4\u5c31\u53bb\u5b50\u5f97\u4e5f\u548c\u90a3\u8981\u4e0b"
				+ "\u770b\u5929\u65f6\u8fc7\u51fa\u5c0f\u4e48\u8d77\u4f60\u90fd\u628a"
				+ "\u597d\u8fd8\u591a\u6ca1\u4e3a\u53c8\u53ef\u5bb6\u5b66\u53ea\u4ee5"
